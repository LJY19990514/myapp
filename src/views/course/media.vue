<template>
    <div class="app-container">
        ...
        <el-button class="add-btn" icon="el-icon-edit"  type="primary" @click="handleCreate">新增图文</el-button>
        ...
        <el-dialog fullscreen :visible.sync="dialogFormVisible">
            <div align="center">
                <img :src="dialogImgUrl" class="image" width="100%" @error="imgUrlDefault">
            </div>
        </el-dialog>
    </div>
</template>
